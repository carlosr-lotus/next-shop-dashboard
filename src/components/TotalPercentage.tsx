    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.area}>
                <svg className={styles.waves} style={{maxHeight: `${props.value}%`}} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 28" preserveAspectRatio="none" shapeRendering="auto">
                    <defs>
